...
export default function Watch() {
  ...
  useEffect(() => {
    ...
    console.warn("QI ENABLE", localStorage.getItem("YTKIDD:QUIZ:ENABLE"))
  ...
  useEffect(() => {
    ...
    console.warn("Q ENABLE", localStorage.getItem("YTKIDD:QUIZ:ENABLE"))
    if (localStorage && localStorage.getItem("YTKIDD:QUIZ:ENABLE") !== "off") {
      setQuizTs(Date.now())
    }
  ...
  useEffect(() => {
    const execCallback = () => {
      ...
      console.warn("QT ENABLE", localStorage.getItem("YTKIDD:QUIZ:ENABLE"))
